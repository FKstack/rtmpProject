...
public:
    ...
    void setValidationLayoutEnabled(bool enabled);
...
private:
    ...
    GridTransitionAnimator *transitionAnimator_ = nullptr;
    ...
    bool validationLayoutEnabled_ = false;
    QString displayFpsRequest_ = QStringLiteral("auto");
    int displayTargetFps_ = 30;
