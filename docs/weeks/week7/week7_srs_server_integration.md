...
> 对应方案：`docs/srs_server_integration_plan.md`（Phase 1～7）。
>
...
docs/weeks/week7/week7_srs_server_integration.md（本文）
```
...
docs/guides/build-and-testing/rtmp_chain_verification.md   §15 SRS 入口（nginx 历史保留）
docs/guides/build-and-testing/cross_platform_build.md      §9 SRS ARM 部署边界
...
- 新增文件：`docs/guides/build-and-testing/srs_failure_recovery.md`；
...
故障恢复矩阵与发布门禁：
[../guides/build-and-testing/srs_failure_recovery.md](../guides/build-and-testing/srs_failure_recovery.md)
