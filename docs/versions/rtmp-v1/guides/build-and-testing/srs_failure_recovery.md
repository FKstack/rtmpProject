...
> 文档分类：构建与验证。对应 `docs/versions/rtmp-v1/architecture/srs_server_integration_plan.md` Phase 7。
>
> 最近独立复验：2026-08-09。平台：Windows 11 + WSL2 Ubuntu 22.04
...
入口，应先设计并提交受跟踪脚本，当前 Git 源码树不声明一个不存在的入口。

## 6. 与其他文档的关系

- 部署与脚本入口：[RTMP 链路验证 §15](rtmp_chain_verification.md)
- ARM 部署边界：[跨平台构建 §9](cross_platform_build.md)
- 方案与 `[需要验证]` 清单：`docs/versions/rtmp-v1/architecture/srs_server_integration_plan.md` 第 15 节
