...
> 历史记录：本文中的 Week 4 本机测试脚本已经退役，保留命令仅用于解释当时结果。参见[遗留脚本索引](../../archive/legacy_test_scripts.md)。
...
本节历史上使用 `test_week4_multi_stream.ps1`（见[遗留脚本索引](../../archive/legacy_test_scripts.md)）
